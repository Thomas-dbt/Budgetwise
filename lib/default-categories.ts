export const defaultCategories = [
    {
        ...
        subCategories: [
            ...
            { name: 'Restaurant/Fast Food', keywords: ['Restaurant', 'Resto', 'Brasserie', 'Bistrot', 'Snack', 'Sandwich', 'Tacos', 'Kebab', 'Burger', 'Pizzeria', 'Sushi', 'Wok', 'Poke', 'Creperie', 'McDonald', 'Burger King', 'KFC', 'Quick', 'Subway', 'Dominos', 'Pizza Hut', 'O Tacos', 'Five Guys', 'Big Fernand', 'Pret A Manger', 'EXKI', 'Flunch', 'Buffalo Grill', 'Hippopotamus', 'Del Arte'] },
    ...
    },
    {
        ...
        subCategories: [
            ...
            { name: 'Assurance habitation', keywords: ['Assurance habitation', 'MRH', 'Pacifica'] },
            { name: 'Taxe foncière', keywords: ['DGFIP', 'Impots', 'Taxe fonciere', 'Tresor Public'] },
            { name: 'Entretien', keywords: ['Leroy Merlin', 'Castorama', 'Bricorama', 'Brico Depot', 'Mr Bricolage', 'Bricomarche', 'Weldom', 'ManoMano', 'Action', 'Gamm Vert', 'Jardiland', 'Point P', 'Cedeo', 'Rexel'] },
    ...
    },
    {
        ...
        subCategories: [
            ...
            { name: 'Transport en commun', keywords: ['SNCF', 'SNCF Connect', 'OuiGo', 'Trainline', 'RATP', 'Navigo', 'Bus', 'Tram', 'TER', 'TGV', 'Keolis', 'Transdev'] },
            { name: 'Assurance auto', keywords: ['Assurance auto', 'Direct Assurance'] },
    ...
    },
    {
        ...
        subCategories: [
            ...
            { name: 'Voyages', keywords: ['Voyage', 'Sejour', 'Vacances', 'Weekend', 'City trip', 'Airbnb', 'Booking', 'Hotel', 'Ibis', 'Novotel', 'Campanile', 'EasyJet', 'Air France', 'Ryanair', 'Transavia', 'Flixbus', 'BlaBlaCar', 'Club Med', 'Center Parcs', 'Camping', 'Hostel', 'Expedia'] },
    ...
    },
    {
        ...
        subCategories: [
            ...
            { name: 'Cadeaux & Plaisir', keywords: ['Gift'] },
            { name: 'High-Tech', keywords: ['Apple', 'Samsung', 'Darty', 'LDLC', 'Materiel.net', 'Cdiscount', 'Back Market'] },
    ...
    },
    {
        ...
        subCategories: [
            ...
            { name: 'Internet', keywords: ['Box', 'Fibre', 'ADSL', 'Free', 'Bouygues Telecom'] },
    ...
    },
    {
        ...
        emoji: '⚡',
        subCategories: [
            { name: 'Électricité', keywords: ['EDF', 'Electricite', 'Ilek', 'Mint Energie', 'Ohm Energie'] },
    ...
    },
    {
        ...
        emoji: '🐷',
        subCategories: [
            { name: 'Livrets', keywords: ['Livret A', 'LDDS', 'LEP', 'PEL', 'Livret', 'Epargne', 'Virement epargne', 'CEL'] },
            { name: 'Cagnotte', keywords: ['Cagnotte', 'Tirelire'] }
        ]
    },
    {
        name: 'Investissement',
