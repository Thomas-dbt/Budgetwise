...
INSERT INTO "new_CalendarEvent" ("amount", "categoryId", "confirmed", "createdAt", "dueDate", "emailReminderDaysBefore", "id", "notifyByEmail", "recurring", "title", "type", "userId") SELECT "amount", "categoryId", "confirmed", "createdAt", "dueDate", "emailReminderDaysBefore", "id", "notifyByEmail", "recurring", "title", "type", "userId" FROM "CalendarEvent";
